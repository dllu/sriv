...
* animated GIF, WebP, APNG, and JPEG XL playback with per-frame timing
* color-managed ICC, HEIF/NCLX, and JPEG XL images, with Display P3 output when the surface supports it
